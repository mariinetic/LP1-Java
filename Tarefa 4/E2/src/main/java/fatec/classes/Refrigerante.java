...
public class Refrigerante {
    ...
    public Refrigerante(String _nome, String _sabor, String _marca, int _volumeML, boolean _diet) {
        this.nome = _nome;
        this.sabor = _sabor;
        this.marca = _marca;
    ...
    // Compara o sabor com outro refrigerante
    ...
    public String Abrir() {
        return(this.nome + " foi aberto e está pronto para ser consumido.");
    }

    public String Servir() {
        return(this.nome + " está sendo servido.");
    }
