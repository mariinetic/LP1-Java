...
public class TestaClasse {
    public static void main(String[] args) {
        ...
        JogadorasDeVolei jogadora = new JogadorasDeVolei("Ana", "Oposta", 1.85, 7);
        KpopSingers kpopSinger = new KpopSingers("Jin", 28, "BTS", 1.78);
        Planeta planeta = new Planeta("Terra", 1.0, 12742, 149.6, false);
        Refrigerante refrigerante = new Refrigerante("Coca-Cola", "Cola", "Coca-Cola Company", 350, false);
        Salgadinhos salgadinho = new Salgadinhos("Queijo Nacho", 120.0, 10);
        Salgadinhos salgadinho2 = new Salgadinhos("Original", 100.0, 7);
        Sanrio sanrio = new Sanrio("Hello Kitty", "Maçã", "Rosa", 10);
        TiposDeCabelo cabelo = new TiposDeCabelo("Ondulado", "Castanho", 30.0, true);
        TrabalhadoresDeEscritorio trabalhador = new TrabalhadoresDeEscritorio("Carlos", "Gerente", 8500.0);
